      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
          ...
          <div className="text-sm text-blue-700">
            ...
            <p>Your data is stored locally in your browser. Regular backups ensure you don't lose your financial data if you clear browser data or switch devices.</p>
          </div>
        </div>
        ...
        <div className="text-xs text-muted-foreground">
          ...
          <ul className="list-disc list-inside space-y-1 mt-1">
            ...
            <li>Keep backup files in a safe location (cloud storage, email, etc.)</li>
